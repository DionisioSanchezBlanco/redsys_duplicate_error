...
class WC_Redsys extends WC_Payment_Gateway {
    ...
    function generate_redsys_form( $order_id ) {
            // Version
        $merchantModule = 'wo_redsys_3.1.1';
	...
	// creamos un nuevo número de pedido para mandar a la pasarela de pago y que no cree duplicidades
        ...
        $miObj->setParameter("DS_MERCHANT_ORDER",$numpedido_id2);
        ...
        return '<form action="'.$action.'" method="post" id="redsys_payment_form">'. 
                    ...
                    '<input type="submit" class="button-alt" id="submit_redsys_payment_form" value="'.__('Pay now', 'redsys').'" />'.
